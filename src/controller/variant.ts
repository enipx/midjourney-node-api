...
export const variantHandler = async (req: Request, res: Response) => {
  try {
    ...
    const imagineRes = await client.Variation({
      content,
      index,
      msgId: imageId,
      hash,
...
// @TODO: implement this
export const streamVariantHandler = async (req: Request, res: Response) => {};
